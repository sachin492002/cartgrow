...
function Upi({theme, handleSubmit}: Props) {
    // @ts-ignore
            ...
            <div className="mx-auto w-full max-w-lg">
                ...
                <form  onSubmit={handleSubmit} className="mt-10 flex flex-col space-y-4">
                    ...
                    <div className="relative"><label htmlFor="card-number"
                                                     className="text-xs font-semibold text-gray-500">UPI
                        Id</label><input type="text" id="card-number" name="card-number" required={true}
